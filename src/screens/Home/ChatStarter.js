...
import { View, Text, Image, SafeAreaView, StyleSheet, ScrollView, FlatList, StatusBar, TouchableOpacity } from 'react-native';
...
const msgData = [
    ...
    {
        id: 53,
        text: 'WOULD YOU RATHER HAVE A HOME COOKED MEAL DATE OR A RESERVATION MAKING TYPE OF DATE? WHAT IS YOUR ALL-TIME FAVORITE MOVIE?',
    },
    {
        id: 54,
                    ...
                    renderItem={({ item }) => (
                        ...
                        <View style={tw`w-full flex flex-row bg-gray-200  rounded-lg mt-3 `}>
                            ...
                            >
                                ...
                                <Text style={[{ fontFamily: 'Regular' }, tw`text-sm text-center overflow-hidden flex-grow `]}>
                                    {item.text}
                                </Text>
