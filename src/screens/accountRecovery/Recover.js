        ...
        <View style={tw`flex-1 items-center`}>
            <View style={tw`flex-1 content-center items-center p-4`}>
                ...
                <View style={tw`flex justify-center items-center`}>
                    ...
                    <Text style={tw`pt-6 text-base max-w-md`}>
                ...
                <View style={tw`mt-12 flex justify-center items-center`}>
                    ...
                    >
                        <Text style={tw`text-white text-center font-bold text-base flex items-center`}><Email style={tw`text-left pt-2`} />Recover with Email</Text>
                    </TouchableOpacity>
                </View>
            </View>
            <View>
