					...
					<View style={tw`flex items-center`}>
						...
						<Text
							style={[
								...
								{ lineHeight: 20, fontFamily: 'Regular' }
							]}
						>
							Your number have been successfully verified. Continue with your account setup.
						</Text>
						<View style={tw`pt-36`} />
						...
						>
							<Text
								style={[
									{ fontFamily: 'Bold' },
									tw`text-white text-center font-bold text-base flex items-center text-xl`
								]}
							>
								Continue
							</Text>
