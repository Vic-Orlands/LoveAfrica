...
import { View, Text, StyleSheet, Pressable, Plateform, Button, TextInput, TouchableOpacity } from 'react-native';
    ...
    return (
        <View style={tw`flex-1 items-center p-4`}>
            <View style={tw`flex-1 p-4`}>
                <View style={tw`pt-2`}>
                    <Text style={tw`font-bold text-3xl text-center pb-4`}> Date of Birth</Text>
                </View>
                <View style={tw`mt-8`} />
                <View style={tw`flex items-center`}>
                    ...
                    >
                        <Text style={tw` font-bold  `}>{val}</Text>
                    </TouchableOpacity>
